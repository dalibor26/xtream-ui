...
rm install.py; wget [https://github.com/dalibor26/xtream-ui/blob/xtream-ui_installation/install.py](https://github.com/dalibor26/xtream-ui/blob/xtream-ui_installation/install.py);
