...
rDownloadURL = "https://github.com/dalibor26/xtream-ui/releases/download/downloads/LB.tar.gz"
...
def configure():
    ...
    os.system("wget -q https://github.com/dalibor26/xtream-ui/releases/download/downloads/nginx_rtmp -O /home/xtreamcodes/iptv_xtream_codes/nginx/sbin/nginx_rtmp")
