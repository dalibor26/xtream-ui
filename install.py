...
rDownloadURL = {"main": "https://github.com/dalibor26/xtream-ui/releases/download/downloads/main.tar.gz", "sub": "https://github.com/dalibor26/xtream-ui/releases/download/downloads/LB.tar.gz"}
...
def installadminpanel():
    rURL = "https://github.com/dalibor26/xtream-ui/releases/download/downloads/release_22f.zip"
    ...
    rURL2 = "https://github.com/dalibor26/xtream-ui/releases/download/downloads/newstuff.zip"
...
def configure():
    ...
    os.system("wget -q https://github.com/dalibor26/xtream-ui/releases/download/downloads/nginx -O /home/xtreamcodes/iptv_xtream_codes/nginx/sbin/nginx")
    os.system("wget -q https://github.com/dalibor26/xtream-ui/releases/download/downloads/nginx_rtmp -O /home/xtreamcodes/iptv_xtream_codes/nginx_rtmp/sbin/nginx_rtmp")
    os.system("wget -q https://github.com/dalibor26/xtream-ui/releases/download/downloads/pid_monitor.php -O /home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php")
    ...
    os.system("wget -q https://github.com/dalibor26/xtream-ui/releases/download/downloads/GeoLite2.mmdb -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb")
    os.system('chattr -f +i /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb > /dev/null')
...
if __name__ == "__main__":
    ...
    print "%s │ Check out the mirror repo: https://github.com/dalibor26/xtream-ui %s" % (col.OKGREEN, col.ENDC)
    print " "
