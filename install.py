...
rDownloadURL = {"main": "https://github.com/dalibor26/xtream-ui/releases/download/latest/main.tar.gz", "sub": "https://github.com/dalibor26/xtream-ui/releases/download/latest/LB.tar.gz"}
...
def installadminpanel():
    rURL = "https://github.com/dalibor26/xtream-ui/releases/download/latest/release_22f.zip"
    ...
    rURL2 = "https://github.com/dalibor26/xtream-ui/releases/download/latest/newstuff.zip"
...
def configure():
    ...
    os.system("wget -q https://github.com/dalibor26/xtream-ui/releases/download/latest/nginx -O /home/xtreamcodes/iptv_xtream_codes/nginx/sbin/nginx")
    os.system("wget -q https://github.com/dalibor26/xtream-ui/releases/download/latest/nginx_rtmp -O /home/xtreamcodes/iptv_xtream_codes/nginx_rtmp/sbin/nginx_rtmp")
    os.system("wget -q https://github.com/dalibor26/xtream-ui/releases/download/latest/pid_monitor.php -O /home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php")
    ...
    os.system("wget -q https://github.com/dalibor26/xtream-ui/releases/download/latest/GeoLite2.mmdb -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb")
    os.system('chattr -f +i /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb > /dev/null')
